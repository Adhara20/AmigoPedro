...
<div class="flex min-h-screen flex-col justify-center px-6 py-20">
    ...
    <div class="sm:mx-auto sm:w-full sm:max-w-sm flex items-center justify-center gap-4">
        ...
        <h2 class="text-2xl font-bold text-gray-900">Registrar Nueva Promocion</h2>
    </div>
        ...
        <form class="space-y-6">
            ...
            <div>
                ...
                <input type="text"
                    ...
                    placeholder="Nombre De Promocion" required>
            </div>
            ...
            <!-- Precio de descuento -->
            <div>
                <label class="block text-md font-medium text-gray-700 mb-1"> Descuento <span class="text-red-500 mb-2 font-bold"> * </span></label>
                <input type="INT"
                    class="block w-full px-3 py-2 text-base rounded-md border border-gray-300 
                           focus:outline-none focus:ring-2 focus:ring-[#0E247B] focus:border-transparent
                           placeholder:text-gray-400 transition duration-150"
                    placeholder="$ Precio De Descuento" required>
            </div>
            ...
            <div>
                ...
                <input type="date"
                    class="block w-full px-3 py-2 text-base rounded-md border border-gray-300 
                           focus:outline-none focus:ring-2 focus:ring-[#0E247B] focus:border-transparent
                           placeholder:text-gray-400 transition duration-150"
                    placeholder="Fecha de inicio de la promocion" required>
            </div>
